...
) ENGINE = InnoDB AUTO_INCREMENT = 208 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'DBI-市级表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `dbi_district`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 17 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'DBI-区表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `dbi_expend`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 8794 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'DBI-支出表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `dbi_income`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 884 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'DBI-收入表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `dbi_number`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 9005 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'DBI-人数统计表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `dbi_office_map`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 29 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'DBI-分公司地图表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `dbi_profit`  (
  ...
  `company_id` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '对应公司的id',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2495 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'DBI-利润表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `dbi_province`  (
  ...
  `lat` varchar(300) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '市维度',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 49 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'DBI-省级表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ehr_activity`  (
  ...
  `initateTime` datetime(0) NULL DEFAULT NULL COMMENT '活动时间',
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 17 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '团建活动表' ROW_FORMAT = Dynamic;
...
INSERT INTO `ehr_activity` VALUES (8, '君合天下馨暖人间', '上海明珠大酒店', '公司年会', '君合天下馨暖人间主题晚会', '2015-12-29 20:00:00', 360000, 1, 1, 0);
INSERT INTO `ehr_activity` VALUES (9, '同心同行共创未来', '四川蜀中味大酒店', '公司年会', '同心同行共创未来主题晚会', '2018-03-29 20:00:00', 380000, 1, 1, 0);
INSERT INTO `ehr_activity` VALUES (10, '123', '123', '123', '123', '2018-04-27 00:00:00', 123, 1, 10000, 0);
INSERT INTO `ehr_activity` VALUES (11, '二', '为', '饿', '为', '2018-04-18 00:00:00', 4545, 2, 45, 1);
INSERT INTO `ehr_activity` VALUES (12, '23', '324', '324', '324', '2018-04-03 00:00:00', 343434, 1, 1, 0);
INSERT INTO `ehr_activity` VALUES (13, '34', '34', '34', '324', '2018-04-04 00:00:00', 34, 2, 2, 0);
INSERT INTO `ehr_activity` VALUES (14, '吃鸡', '机场', '我们一起跳机场，抢警局，然后占英雄楼', '干！', '2019-01-30 00:00:00', 889, 1, 4, 1);
INSERT INTO `ehr_activity` VALUES (15, '哈哈哈哈', '嘻嘻嘻嘻', '嘿嘿嘿嘿', '<img src=\"/other/img/2019/01/26/f9fdb38c-9e19-4ae0-9510-fcf30a3d2988.png\" alt=\"undefined\">', '2019-01-24 00:00:00', 998, 1, 10035, 1);
INSERT INTO `ehr_activity` VALUES (16, '一次', 'ii', 'uu', '<img src=\"/other/img/2019/01/26/f5f8e44f-8c3d-44f5-a9d9-5aece65b9e19.png\" alt=\"undefined\">', '2019-01-25 00:00:00', 988, 0, 10218, 1);
...
CREATE TABLE `ehr_applicant`  (
  ...
  `logicToDelete` int(2) NULL DEFAULT 1 COMMENT '逻辑删除字段',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 27 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '应聘者管理表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of ehr_applicant
-- ----------------------------
INSERT INTO `ehr_applicant` VALUES (1, '李宇龙', 0, '13578945612', '991408278', '1072571403@qq.com', 14, '湖北宜昌', '2019-06-29', '善与人交流，专业技能强', '外表精神，沟通能力强，学习能力强，工作经验丰富，团队合作精神对企业的认可强', '优秀', NULL);
INSERT INTO `ehr_applicant` VALUES (2, '李晓晨', 0, '17765248964', '1369191990', '1369191990@qq.com', 24, '湖北武汉', '2013-06-27', '专业技术强', '外表精神，沟通能力一般，学习能力一般，工作经验丰富，团队合作精神对企业的认可一般', '良好', 1);
INSERT INTO `ehr_applicant` VALUES (3, '曾庆', 1, '13972379641', '1833575641', '1833575641@qq.com', 31, '四川成都', '2018-03-02', '专业能力强', '衣着整洁，沟通能力弱，学习能力强，缺少工作经验，团队合作精神对企业的认可一般', '优秀', 1);
...
CREATE TABLE `ehr_articlewages`  (
  ...
  `time` datetime(0) NULL DEFAULT NULL COMMENT '发放时间',
  `realHair` int(11) NULL DEFAULT NULL COMMENT '实发工资',
  `logicToDelete` int(11) NULL DEFAULT NULL COMMENT '逻辑删除字段',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 130980 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '工资条表' ROW_FORMAT = Dynamic;
...
INSERT INTO `ehr_articlewages` VALUES (872, 14, '李焱阳', 7500, 0, 200, 150, '2018-01-01 21:48:49', 7150, 3);
INSERT INTO `ehr_articlewages` VALUES (873, 15, '杨文虎', 7500, 0, 100, 150, '2018-01-01 21:48:49', 7250, 3);
INSERT INTO `ehr_articlewages` VALUES (874, 16, '刘良斌', 7800, 300, 200, 210, '2018-01-01 21:48:49', 7690, 2);
INSERT INTO `ehr_articlewages` VALUES (875, 17, '牛建旺', 9800, 300, 550, 450, '2018-01-01 21:48:49', 9100, 2);
INSERT INTO `ehr_articlewages` VALUES (876, 18, '刘治成', 14800, 0, 130, 700, '2018-01-01 21:48:49', 13970, 2);
INSERT INTO `ehr_articlewages` VALUES (877, 19, '任志国', 10355, 0, 200, 388, '2018-01-01 21:48:49', 9767, 2);
INSERT INTO `ehr_articlewages` VALUES (878, 20, '刘晨威', 10355, 0, 200, 388, '2018-01-01 21:48:49', 9767, 2);
INSERT INTO `ehr_articlewages` VALUES (879, 21, '苏满', 11800, 300, 200, 350, '2018-01-01 21:48:49', 11550, 2);
INSERT INTO `ehr_articlewages` VALUES (880, 22, '张浩思', 6758, 173, 9, 297, '2018-01-01 21:48:49', 6625, 2);
...
CREATE TABLE `ehr_attendance`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `clockInTime` datetime(0) NULL DEFAULT NULL,
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1389 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '考勤表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of ehr_attendance
-- ----------------------------
INSERT INTO `ehr_attendance` VALUES (1330, '2018-04-23 08:30:00', '旷工', 3, 21, 1);
INSERT INTO `ehr_attendance` VALUES (1331, '2018-04-23 08:30:00', '旷工', 3, 1, 1);
INSERT INTO `ehr_attendance` VALUES (1332, '2018-04-23 08:30:00', '旷工', 2, 2, 1);
INSERT INTO `ehr_attendance` VALUES (1333, '2018-04-23 08:30:00', '旷工', 2, 3, 1);
INSERT INTO `ehr_attendance` VALUES (1334, '2018-04-23 08:30:00', '旷工', 3, 4, 1);
...
INSERT INTO `ehr_attendance` VALUES (1343, '2018-04-23 08:30:00', '旷工', 3, 15, 1);
INSERT INTO `ehr_attendance` VALUES (1344, '2018-04-23 08:30:00', '旷工', 3, 22, 1);
INSERT INTO `ehr_attendance` VALUES (1345, '2018-04-23 08:30:00', '旷工', 3, 23, 1);
INSERT INTO `ehr_attendance` VALUES (1346, '2018-04-23 08:30:00', '旷工', 3, 24, 1);
INSERT INTO `ehr_attendance` VALUES (1347, '2018-04-23 08:30:00', '旷工', 3, 25, 1);
INSERT INTO `ehr_attendance` VALUES (1348, '2018-04-23 08:30:00', '旷工', 3, 26, 1);
INSERT INTO `ehr_attendance` VALUES (1349, '2018-04-23 08:30:00', '旷工', 3, 27, 1);
INSERT INTO `ehr_attendance` VALUES (1350, '2018-04-23 08:30:00', '旷工', 3, 28, 1);
INSERT INTO `ehr_attendance` VALUES (1351, '2018-04-23 08:30:00', '旷工', 3, 30, 1);
INSERT INTO `ehr_attendance` VALUES (1352, '2018-04-23 08:30:00', '旷工', 3, 31, 1);
INSERT INTO `ehr_attendance` VALUES (1353, '2018-04-23 08:30:00', '旷工', 3, 32, 1);
INSERT INTO `ehr_attendance` VALUES (1354, '2018-04-23 08:30:00', '旷工', 3, 10007, 1);
INSERT INTO `ehr_attendance` VALUES (1355, '2018-04-23 08:30:00', '旷工', 3, 10008, 1);
INSERT INTO `ehr_attendance` VALUES (1356, '2018-04-23 08:30:00', '旷工', 3, 10009, 1);
INSERT INTO `ehr_attendance` VALUES (1357, '2018-04-23 08:30:00', '旷工', 3, 10010, 1);
INSERT INTO `ehr_attendance` VALUES (1358, '2018-04-23 12:24:43', '迟到', 2, 20, 1);
INSERT INTO `ehr_attendance` VALUES (1359, '2018-04-24 08:30:00', '旷工', 3, 1, 1);
INSERT INTO `ehr_attendance` VALUES (1360, '2018-04-24 08:30:00', '旷工', 3, 2, 1);
INSERT INTO `ehr_attendance` VALUES (1361, '2018-04-24 08:30:00', '旷工', 3, 3, 1);
INSERT INTO `ehr_attendance` VALUES (1362, '2018-04-24 08:30:00', '旷工', 3, 4, 1);
INSERT INTO `ehr_attendance` VALUES (1363, '2018-04-24 08:30:00', '旷工', 3, 5, 1);
INSERT INTO `ehr_attendance` VALUES (1364, '2018-04-24 08:30:00', '旷工', 3, 6, 1);
INSERT INTO `ehr_attendance` VALUES (1365, '2018-04-24 08:30:00', '旷工', 3, 8, 1);
INSERT INTO `ehr_attendance` VALUES (1366, '2018-04-24 08:30:00', '旷工', 3, 9, 1);
INSERT INTO `ehr_attendance` VALUES (1367, '2018-04-24 08:30:00', '旷工', 3, 10, 1);
INSERT INTO `ehr_attendance` VALUES (1368, '2018-04-24 08:30:00', '旷工', 3, 11, 1);
INSERT INTO `ehr_attendance` VALUES (1369, '2018-04-24 08:30:00', '旷工', 3, 12, 1);
INSERT INTO `ehr_attendance` VALUES (1370, '2018-04-24 08:30:00', '旷工', 3, 15, 1);
INSERT INTO `ehr_attendance` VALUES (1371, '2018-04-24 08:30:00', '旷工', 3, 20, 1);
INSERT INTO `ehr_attendance` VALUES (1372, '2018-04-24 08:30:00', '旷工', 3, 22, 1);
INSERT INTO `ehr_attendance` VALUES (1373, '2018-04-24 08:30:00', '旷工', 3, 23, 1);
INSERT INTO `ehr_attendance` VALUES (1374, '2018-04-24 08:30:00', '旷工', 3, 24, 1);
INSERT INTO `ehr_attendance` VALUES (1375, '2018-04-24 08:30:00', '旷工', 3, 25, 1);
INSERT INTO `ehr_attendance` VALUES (1376, '2018-04-24 08:30:00', '旷工', 3, 26, 1);
INSERT INTO `ehr_attendance` VALUES (1377, '2018-04-24 08:30:00', '旷工', 3, 27, 1);
INSERT INTO `ehr_attendance` VALUES (1378, '2018-04-24 08:30:00', '旷工', 3, 28, 1);
INSERT INTO `ehr_attendance` VALUES (1379, '2018-04-24 08:30:00', '旷工', 3, 30, 1);
INSERT INTO `ehr_attendance` VALUES (1380, '2018-04-24 08:30:00', '旷工', 3, 31, 1);
INSERT INTO `ehr_attendance` VALUES (1381, '2018-04-24 08:30:00', '旷工', 3, 32, 1);
INSERT INTO `ehr_attendance` VALUES (1382, '2018-04-24 08:30:00', '旷工', 3, 10007, 1);
INSERT INTO `ehr_attendance` VALUES (1383, '2018-04-24 08:30:00', '旷工', 3, 10008, 1);
INSERT INTO `ehr_attendance` VALUES (1384, '2018-04-24 08:30:00', '旷工', 3, 10009, 1);
INSERT INTO `ehr_attendance` VALUES (1385, '2018-04-24 08:30:00', '旷工', 3, 10010, 1);
INSERT INTO `ehr_attendance` VALUES (1386, '2018-04-24 08:49:47', '迟到', 2, 21, 1);
INSERT INTO `ehr_attendance` VALUES (1387, '2018-04-24 10:20:20', '旷工', 3, 10015, 1);
INSERT INTO `ehr_attendance` VALUES (1388, '2018-04-24 10:21:26', '旷工', 3, 7, 1);
...
CREATE TABLE `ehr_channel`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 13 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '渠道管理表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ehr_company`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3358 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '公司表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of ehr_company
-- ----------------------------
INSERT INTO `ehr_company` VALUES (1, '一', '312321', 'zzzz', NULL, NULL);
INSERT INTO `ehr_company` VALUES (2, '二', '21312', NULL, 1, NULL);
INSERT INTO `ehr_company` VALUES (3, '三', '213', '1', 1, '2019-06-19 11:08:17');
INSERT INTO `ehr_company` VALUES (4, '四', '3', '1', 1, '2019-06-19 11:08:17');
INSERT INTO `ehr_company` VALUES (5, '五', '42', '1', 1, '2019-06-19 11:08:17');
INSERT INTO `ehr_company` VALUES (6, '6', '12312', '1', 1, '2019-06-19 11:08:17');
INSERT INTO `ehr_company` VALUES (7, '7暗', '23213', '1', 1, '2019-06-19 11:08:17');
INSERT INTO `ehr_company` VALUES (8, '暗', '2', '1', 1, '2019-06-19 11:08:17');
INSERT INTO `ehr_company` VALUES (9, '9', '3', '3', 1, '2019-06-19 11:08:17');
INSERT INTO `ehr_company` VALUES (10, '10暗', '321', '3', 1, '2019-06-19 11:08:17');
INSERT INTO `ehr_company` VALUES (11, '11', '1', '1', 1, '2019-06-19 11:08:17');
INSERT INTO `ehr_company` VALUES (12, '12', '2', '1', 1, '2019-06-19 11:08:17');
INSERT INTO `ehr_company` VALUES (13, '13', '3', '1', 1, '2019-06-19 11:08:17');
INSERT INTO `ehr_company` VALUES (14, '14', '4', '1', 1, '2019-06-19 11:08:17');
INSERT INTO `ehr_company` VALUES (15, '15', '5', '1', 1, '2019-06-19 11:08:17');
INSERT INTO `ehr_company` VALUES (16, '16', '6', '1', 1, '2019-06-19 11:08:17');
INSERT INTO `ehr_company` VALUES (17, '17', '7', '1', 1, '2019-06-19 11:08:17');
INSERT INTO `ehr_company` VALUES (18, '18', '8', '1', 1, '2019-06-19 11:08:17');
INSERT INTO `ehr_company` VALUES (19, '19', '9', '1', 1, '2019-06-19 11:08:17');
INSERT INTO `ehr_company` VALUES (20, '20', '1', '1', 1, '2019-06-19 11:08:17');
INSERT INTO `ehr_company` VALUES (21, '21', '1', '1', 1, '2019-06-19 11:08:17');
INSERT INTO `ehr_company` VALUES (22, '22', '1', '1', 1, '2019-06-19 11:08:17');
INSERT INTO `ehr_company` VALUES (23, '23', '1', '11', 1, '2019-06-19 11:08:17');
INSERT INTO `ehr_company` VALUES (3356, '宇宙无敌小霸王', '32', '777', 1, '2019-06-19 11:08:17');
...
CREATE TABLE `ehr_compensation`  (
  ...
  `logicToDelete` int(2) NULL DEFAULT 1 COMMENT '逻辑删除字段',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 77 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '薪资表' ROW_FORMAT = Dynamic;
...
INSERT INTO `ehr_compensation` VALUES (58, 5000, 800, 3, 20, 1);
INSERT INTO `ehr_compensation` VALUES (59, 10000, 800, 3, 21, 1);
INSERT INTO `ehr_compensation` VALUES (60, 5555, 800, 3, 22, 1);
INSERT INTO `ehr_compensation` VALUES (61, 5555, 800, 3, 23, 1);
INSERT INTO `ehr_compensation` VALUES (62, 5555, 800, 3, 24, 1);
INSERT INTO `ehr_compensation` VALUES (63, 5555, 800, 3, 25, 1);
INSERT INTO `ehr_compensation` VALUES (64, 5555, 800, 5, 99, 1);
INSERT INTO `ehr_compensation` VALUES (70, 5000, 8000, 3, 100, 1);
INSERT INTO `ehr_compensation` VALUES (72, 6000, 500, 1, 101, 1);
INSERT INTO `ehr_compensation` VALUES (73, 5000, 500, 1, 10008, 1);
INSERT INTO `ehr_compensation` VALUES (74, 5000, 500, 1, 10015, 1);
INSERT INTO `ehr_compensation` VALUES (75, 5000, 300, 2, 30, 1);
INSERT INTO `ehr_compensation` VALUES (76, 1000, 300000, 21, 10211, 1);
...
CREATE TABLE `ehr_departure`  (
  ...
  `logicToDelete` int(2) NULL DEFAULT 1 COMMENT '逻辑删除字段',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 44 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '离职表' ROW_FORMAT = Dynamic;
...
INSERT INTO `ehr_departure` VALUES (29, '迟到太多', '2018-04-21', 7, 0);
INSERT INTO `ehr_departure` VALUES (30, '1111', '2019-01-01', 8, 1);
INSERT INTO `ehr_departure` VALUES (31, '2222', '2019-02-01', 9, 1);
INSERT INTO `ehr_departure` VALUES (32, '3333', '2019-03-01', 10, 1);
INSERT INTO `ehr_departure` VALUES (33, '4444', '2017-11-11', 11, 1);
INSERT INTO `ehr_departure` VALUES (34, '5555', '2011-11-11', 1, 1);
INSERT INTO `ehr_departure` VALUES (36, '6666', NULL, 9, NULL);
INSERT INTO `ehr_departure` VALUES (41, '111', NULL, 7, NULL);
INSERT INTO `ehr_departure` VALUES (42, '1312', NULL, 6, NULL);
INSERT INTO `ehr_departure` VALUES (43, '4565', '2019-06-29', 5, NULL);
...
-- Records of ehr_dept
-- ----------------------------
INSERT INTO `ehr_dept` VALUES (1, '12', ' 12', 1, NULL, NULL);
INSERT INTO `ehr_dept` VALUES (2, '2', '213', 1, 1, NULL);
INSERT INTO `ehr_dept` VALUES (3, '3', '3', 1, 1, NULL);
INSERT INTO `ehr_dept` VALUES (4, '4', '3', 1, 1, NULL);
INSERT INTO `ehr_dept` VALUES (5, '档案部', '制定公司档案制度', 1, 1, '/other/img/2018/02/26/08c71f65-4303-49e0-b2fc-4d585b5963f0.jpg');
INSERT INTO `ehr_dept` VALUES (6, '人力资源部', ' 公司重要文件起草，对外联络工作', 20, NULL, NULL);
...
INSERT INTO `ehr_dept` VALUES (11, '销售部', '负责产品的销售', 1, 0, '/other/img/2018/02/26/08c71f65-4303-49e0-b2fc-4d585b5963f0.jpg');
INSERT INTO `ehr_dept` VALUES (12, '人事部', '负责管理公司的人员变动', 2, 0, '/other/img/2018/02/26/08c71f65-4303-49e0-b2fc-4d585b5963f0.jpg');
INSERT INTO `ehr_dept` VALUES (13, '行政部', '研究公司发展计划', 2, 0, '/other/img/2018/02/26/08c71f65-4303-49e0-b2fc-4d585b5963f0.jpg');
INSERT INTO `ehr_dept` VALUES (14, '文化部', '组织制定公司整体形象', 2, 0, '/other/img/2018/02/26/08c71f65-4303-49e0-b2fc-4d585b5963f0.jpg');
INSERT INTO `ehr_dept` VALUES (15, '业绩部', '协助管理层制定员工综合考评', 2, 0, '/other/img/2018/02/26/08c71f65-4303-49e0-b2fc-4d585b5963f0.jpg');
INSERT INTO `ehr_dept` VALUES (18, '维护管理部', '车辆管理与保险事宜', 2, 0, '/other/img/2018/02/26/08c71f65-4303-49e0-b2fc-4d585b5963f0.jpg');
INSERT INTO `ehr_dept` VALUES (19, '后勤部', '采购日常用品，优化办公环境与保洁', 2, 0, '/other/img/2018/02/26/08c71f65-4303-49e0-b2fc-4d585b5963f0.jpg');
INSERT INTO `ehr_dept` VALUES (20, '人事部', '负责管理公司的人员变动', 3, 0, '/other/img/2018/02/26/08c71f65-4303-49e0-b2fc-4d585b5963f0.jpg');
INSERT INTO `ehr_dept` VALUES (21, '行政部', '研究公司发展计划', 3, 0, '/other/img/2018/02/26/08c71f65-4303-49e0-b2fc-4d585b5963f0.jpg');
INSERT INTO `ehr_dept` VALUES (22, '文化部', '组织制定公司整体形象', 3, 0, '/other/img/2018/02/26/08c71f65-4303-49e0-b2fc-4d585b5963f0.jpg');
INSERT INTO `ehr_dept` VALUES (23, '业绩部', '协助管理层制定员工综合考评', 3, 0, '/other/img/2018/02/26/08c71f65-4303-49e0-b2fc-4d585b5963f0.jpg');
INSERT INTO `ehr_dept` VALUES (24, '档案部', '制定公司档案制度', 3, 0, '/other/img/2018/02/26/08c71f65-4303-49e0-b2fc-4d585b5963f0.jpg');
INSERT INTO `ehr_dept` VALUES (25, '人力资源部', '公司重要文件起草，对外联络工作', 3, 0, '/other/img/2018/02/26/08c71f65-4303-49e0-b2fc-4d585b5963f0.jpg');
INSERT INTO `ehr_dept` VALUES (26, '维护管理部', '车辆管理与保险事宜', 3, 0, '/other/img/2018/02/26/08c71f65-4303-49e0-b2fc-4d585b5963f0.jpg');
INSERT INTO `ehr_dept` VALUES (27, '后勤部', '采购日常用品，优化办公环境与保洁', 3, 0, '/other/img/2018/02/26/08c71f65-4303-49e0-b2fc-4d585b5963f0.jpg');
INSERT INTO `ehr_dept` VALUES (28, '人事部', '负责管理公司的人员变动', 4, 0, '/other/img/2018/02/26/08c71f65-4303-49e0-b2fc-4d585b5963f0.jpg');
INSERT INTO `ehr_dept` VALUES (29, '行政部', '研究公司发展计划', 4, 0, '/other/img/2018/02/26/08c71f65-4303-49e0-b2fc-4d585b5963f0.jpg');
INSERT INTO `ehr_dept` VALUES (30, '文化部', '组织制定公司整体形象', 4, 0, '/other/img/2018/02/26/08c71f65-4303-49e0-b2fc-4d585b5963f0.jpg');
INSERT INTO `ehr_dept` VALUES (31, '业绩部', '协助管理层制定员工综合考评', 4, 0, '/other/img/2018/02/26/08c71f65-4303-49e0-b2fc-4d585b5963f0.jpg');
INSERT INTO `ehr_dept` VALUES (32, '档案部', '制定公司档案制度', 4, 0, '/other/img/2018/02/26/08c71f65-4303-49e0-b2fc-4d585b5963f0.jpg');
INSERT INTO `ehr_dept` VALUES (33, '人力资源部', '公司重要文件起草，对外联络工作', 4, 0, '/other/img/2018/02/26/08c71f65-4303-49e0-b2fc-4d585b5963f0.jpg');
INSERT INTO `ehr_dept` VALUES (34, '维护管理部', '车辆管理与保险事宜', 4, 0, '/other/img/2018/02/26/08c71f65-4303-49e0-b2fc-4d585b5963f0.jpg');
INSERT INTO `ehr_dept` VALUES (35, '后勤部', '采购日常用品，优化办公环境与保洁', 4, 0, '/other/img/2018/02/26/08c71f65-4303-49e0-b2fc-4d585b5963f0.jpg');
INSERT INTO `ehr_dept` VALUES (36, '人事部', '负责管理公司的人员变动', 5, 0, '/other/img/2018/02/26/08c71f65-4303-49e0-b2fc-4d585b5963f0.jpg');
INSERT INTO `ehr_dept` VALUES (37, '行政部', '研究公司发展计划', 5, 0, '/other/img/2018/02/26/08c71f65-4303-49e0-b2fc-4d585b5963f0.jpg');
INSERT INTO `ehr_dept` VALUES (38, '文化部', '组织制定公司整体形象', 5, 0, '/other/img/2018/02/26/08c71f65-4303-49e0-b2fc-4d585b5963f0.jpg');
INSERT INTO `ehr_dept` VALUES (39, '业绩部', '协助管理层制定员工综合考评', 5, 0, '/other/img/2018/02/26/08c71f65-4303-49e0-b2fc-4d585b5963f0.jpg');
INSERT INTO `ehr_dept` VALUES (40, '档案部', '制定公司档案制度', 5, 0, '/other/img/2018/02/26/08c71f65-4303-49e0-b2fc-4d585b5963f0.jpg');
INSERT INTO `ehr_dept` VALUES (41, '人力资源部', '公司重要文件起草，对外联络工作', 5, 0, '/other/img/2018/02/26/08c71f65-4303-49e0-b2fc-4d585b5963f0.jpg');
INSERT INTO `ehr_dept` VALUES (42, '维护管理部', '车辆管理与保险事宜', 5, 0, '/other/img/2018/02/26/08c71f65-4303-49e0-b2fc-4d585b5963f0.jpg');
INSERT INTO `ehr_dept` VALUES (43, '后勤部', '采购日常用品，优化办公环境与保洁', 5, 0, '/other/img/2018/02/26/08c71f65-4303-49e0-b2fc-4d585b5963f0.jpg');
INSERT INTO `ehr_dept` VALUES (44, '人事部', '负责管理公司的人员变动', 6, 0, '/other/img/2018/02/26/08c71f65-4303-49e0-b2fc-4d585b5963f0.jpg');
INSERT INTO `ehr_dept` VALUES (45, '行政部', '研究公司发展计划', 6, 0, '/other/img/2018/02/26/08c71f65-4303-49e0-b2fc-4d585b5963f0.jpg');
INSERT INTO `ehr_dept` VALUES (46, '文化部', '组织制定公司整体形象', 6, 0, '/other/img/2018/02/26/08c71f65-4303-49e0-b2fc-4d585b5963f0.jpg');
INSERT INTO `ehr_dept` VALUES (47, '业绩部', '协助管理层制定员工综合考评', 6, 0, '/other/img/2018/02/26/08c71f65-4303-49e0-b2fc-4d585b5963f0.jpg');
INSERT INTO `ehr_dept` VALUES (48, '档案部', '制定公司档案制度', 6, 0, '/other/img/2018/02/26/08c71f65-4303-49e0-b2fc-4d585b5963f0.jpg');
INSERT INTO `ehr_dept` VALUES (49, '人力资源部', '公司重要文件起草，对外联络工作', 6, 0, '/other/img/2018/02/26/08c71f65-4303-49e0-b2fc-4d585b5963f0.jpg');
INSERT INTO `ehr_dept` VALUES (50, '维护管理部', '车辆管理与保险事宜', 6, 0, '/other/img/2018/02/26/08c71f65-4303-49e0-b2fc-4d585b5963f0.jpg');
INSERT INTO `ehr_dept` VALUES (51, '后勤部', '采购日常用品，优化办公环境与保洁', 6, 0, '/other/img/2018/02/26/08c71f65-4303-49e0-b2fc-4d585b5963f0.jpg');
INSERT INTO `ehr_dept` VALUES (52, '人事部', '负责管理公司的人员变动', 7, 0, '/other/img/2018/02/26/08c71f65-4303-49e0-b2fc-4d585b5963f0.jpg');
INSERT INTO `ehr_dept` VALUES (53, '行政部', '研究公司发展计划', 7, 0, '/other/img/2018/02/26/08c71f65-4303-49e0-b2fc-4d585b5963f0.jpg');
INSERT INTO `ehr_dept` VALUES (54, '文化部', '组织制定公司整体形象', 7, 0, '/other/img/2018/02/26/08c71f65-4303-49e0-b2fc-4d585b5963f0.jpg');
INSERT INTO `ehr_dept` VALUES (55, '业绩部', '协助管理层制定员工综合考评', 7, 0, '/other/img/2018/02/26/08c71f65-4303-49e0-b2fc-4d585b5963f0.jpg');
INSERT INTO `ehr_dept` VALUES (56, '档案部', '制定公司档案制度', 7, 0, '/other/img/2018/02/26/08c71f65-4303-49e0-b2fc-4d585b5963f0.jpg');
INSERT INTO `ehr_dept` VALUES (57, '人力资源部', '公司重要文件起草，对外联络工作', 7, 0, '/other/img/2018/02/26/08c71f65-4303-49e0-b2fc-4d585b5963f0.jpg');
INSERT INTO `ehr_dept` VALUES (58, '维护管理部', '车辆管理与保险事宜', 7, 0, '/other/img/2018/02/26/08c71f65-4303-49e0-b2fc-4d585b5963f0.jpg');
INSERT INTO `ehr_dept` VALUES (59, '后勤部', '采购日常用品，优化办公环境与保洁', 7, 0, '/other/img/2018/02/26/08c71f65-4303-49e0-b2fc-4d585b5963f0.jpg');
INSERT INTO `ehr_dept` VALUES (60, '人事部', '负责管理公司的人员变动', 11, 0, '/other/img/2018/02/26/08c71f65-4303-49e0-b2fc-4d585b5963f0.jpg');
INSERT INTO `ehr_dept` VALUES (61, '行政部', '研究公司发展计划', 11, 0, '/other/img/2018/02/26/08c71f65-4303-49e0-b2fc-4d585b5963f0.jpg');
INSERT INTO `ehr_dept` VALUES (62, '文化部', '组织制定公司整体形象', 11, 0, '/other/img/2018/02/26/08c71f65-4303-49e0-b2fc-4d585b5963f0.jpg');
INSERT INTO `ehr_dept` VALUES (63, '业绩部', '协助管理层制定员工综合考评', 11, 0, '/other/img/2018/02/26/08c71f65-4303-49e0-b2fc-4d585b5963f0.jpg');
INSERT INTO `ehr_dept` VALUES (64, '档案部', '制定公司档案制度', 11, 0, '/other/img/2018/02/26/08c71f65-4303-49e0-b2fc-4d585b5963f0.jpg');
INSERT INTO `ehr_dept` VALUES (65, '人力资源部', '公司重要文件起草，对外联络工作', 11, 0, '/other/img/2018/02/26/08c71f65-4303-49e0-b2fc-4d585b5963f0.jpg');
INSERT INTO `ehr_dept` VALUES (66, '维护管理部', '车辆管理与保险事宜', 11, 0, '/other/img/2018/02/26/08c71f65-4303-49e0-b2fc-4d585b5963f0.jpg');
INSERT INTO `ehr_dept` VALUES (67, '后勤部', '采购日常用品，优化办公环境与保洁', 11, 0, '/other/img/2018/02/26/08c71f65-4303-49e0-b2fc-4d585b5963f0.jpg');
INSERT INTO `ehr_dept` VALUES (68, '人事部', '负责管理公司的人员变动', 12, 0, '/other/img/2018/02/26/08c71f65-4303-49e0-b2fc-4d585b5963f0.jpg');
INSERT INTO `ehr_dept` VALUES (69, '行政部', '研究公司发展计划', 12, 0, '/other/img/2018/02/26/08c71f65-4303-49e0-b2fc-4d585b5963f0.jpg');
INSERT INTO `ehr_dept` VALUES (70, '文化部', '组织制定公司整体形象', 12, 0, '/other/img/2018/02/26/08c71f65-4303-49e0-b2fc-4d585b5963f0.jpg');
INSERT INTO `ehr_dept` VALUES (71, '业绩部', '协助管理层制定员工综合考评', 12, 0, '/other/img/2018/02/26/08c71f65-4303-49e0-b2fc-4d585b5963f0.jpg');
INSERT INTO `ehr_dept` VALUES (72, '档案部', '制定公司档案制度', 12, 0, '/other/img/2018/02/26/08c71f65-4303-49e0-b2fc-4d585b5963f0.jpg');
INSERT INTO `ehr_dept` VALUES (73, '人力资源部', '公司重要文件起草，对外联络工作', 12, 0, '/other/img/2018/02/26/08c71f65-4303-49e0-b2fc-4d585b5963f0.jpg');
INSERT INTO `ehr_dept` VALUES (74, '维护管理部', '车辆管理与保险事宜', 12, 0, '/other/img/2018/02/26/08c71f65-4303-49e0-b2fc-4d585b5963f0.jpg');
INSERT INTO `ehr_dept` VALUES (75, '后勤部', '采购日常用品，优化办公环境与保洁', 12, 0, '/other/img/2018/02/26/08c71f65-4303-49e0-b2fc-4d585b5963f0.jpg');
INSERT INTO `ehr_dept` VALUES (76, '人事部', '负责管理公司的人员变动', 13, 0, '/other/img/2018/02/26/08c71f65-4303-49e0-b2fc-4d585b5963f0.jpg');
INSERT INTO `ehr_dept` VALUES (77, '行政部', '研究公司发展计划', 13, 0, '/other/img/2018/02/26/08c71f65-4303-49e0-b2fc-4d585b5963f0.jpg');
INSERT INTO `ehr_dept` VALUES (78, '文化部', '组织制定公司整体形象', 13, 0, '/other/img/2018/02/26/08c71f65-4303-49e0-b2fc-4d585b5963f0.jpg');
INSERT INTO `ehr_dept` VALUES (79, '业绩部', '协助管理层制定员工综合考评', 13, 0, '/other/img/2018/02/26/08c71f65-4303-49e0-b2fc-4d585b5963f0.jpg');
INSERT INTO `ehr_dept` VALUES (80, '档案部', '制定公司档案制度', 13, 0, '/other/img/2018/02/26/08c71f65-4303-49e0-b2fc-4d585b5963f0.jpg');
INSERT INTO `ehr_dept` VALUES (81, '人力资源部', '公司重要文件起草，对外联络工作', 13, 0, '/other/img/2018/02/26/08c71f65-4303-49e0-b2fc-4d585b5963f0.jpg');
INSERT INTO `ehr_dept` VALUES (82, '维护管理部', '车辆管理与保险事宜', 13, 0, '/other/img/2018/02/26/08c71f65-4303-49e0-b2fc-4d585b5963f0.jpg');
INSERT INTO `ehr_dept` VALUES (83, '后勤部', '采购日常用品，优化办公环境与保洁', 13, 0, '/other/img/2018/02/26/08c71f65-4303-49e0-b2fc-4d585b5963f0.jpg');
INSERT INTO `ehr_dept` VALUES (84, '人事部', '负责管理公司的人员变动', 2, 0, '/other/img/2018/02/26/08c71f65-4303-49e0-b2fc-4d585b5963f0.jpg');
INSERT INTO `ehr_dept` VALUES (85, '行政部', '研究公司发展计划', 14, 0, '/other/img/2018/02/26/08c71f65-4303-49e0-b2fc-4d585b5963f0.jpg');
INSERT INTO `ehr_dept` VALUES (86, '文化部', '组织制定公司整体形象', 14, 0, '/other/img/2018/02/26/08c71f65-4303-49e0-b2fc-4d585b5963f0.jpg');
INSERT INTO `ehr_dept` VALUES (87, '业绩部', '协助管理层制定员工综合考评', 14, 0, '/other/img/2018/02/26/08c71f65-4303-49e0-b2fc-4d585b5963f0.jpg');
INSERT INTO `ehr_dept` VALUES (88, '档案部', '制定公司档案制度', 14, 0, '/other/img/2018/02/26/08c71f65-4303-49e0-b2fc-4d585b5963f0.jpg');
INSERT INTO `ehr_dept` VALUES (89, '人力资源部', '公司重要文件起草，对外联络工作', 14, 0, '/other/img/2018/02/26/08c71f65-4303-49e0-b2fc-4d585b5963f0.jpg');
INSERT INTO `ehr_dept` VALUES (90, '维护管理部', '车辆管理与保险事宜', 14, 0, '/other/img/2018/02/26/08c71f65-4303-49e0-b2fc-4d585b5963f0.jpg');
INSERT INTO `ehr_dept` VALUES (91, '后勤部', '采购日常用品，优化办公环境与保洁', 14, 0, '/other/img/2018/02/26/08c71f65-4303-49e0-b2fc-4d585b5963f0.jpg');
...
CREATE TABLE `ehr_emp`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 10022 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '员工表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of ehr_emp
-- ----------------------------
INSERT INTO `ehr_emp` VALUES (1, 'LiYiHang', NULL, '/other/img/1.jpg', '隐无为', '123', '/other/img/1.jpg', '1995-03-22', '男', '12323123', '709665861', '', 23, '湖北武汉', '2017-05-24', 1, 'html5的运用', '666', 0, 1, 1, 3, 0, 00000000000);
INSERT INTO `ehr_emp` VALUES (2, 'YuKeFeng', NULL, '/other/img/1.jpg', '於克锋', '123', '/other/img/2.jpg', '1995-03-19', '男', '12323123', '573215410', '', 23, '武汉', '2017-05-24', 1, 'html5的运用', '999', 0, 1, 1, 4, 0, 00000000001);
INSERT INTO `ehr_emp` VALUES (3, 'LiChun', NULL, '/other/img/2.jpg', '罗鑫', '123', '/other/img/3.jpg', '1995-07-16', '男', '12323123', '840256574', '', 23, '武汉', '2017-06-14', 1, 'html5的运用', '999', 0, 1, 2, 4, 1, 00000000001);
INSERT INTO `ehr_emp` VALUES (4, 'ZuoGangYa', NULL, '/other/img/3.jpg', '左港亚', '123', '/other/img/4.png', '1997-04-20', '男', '12323123', '2205447957', '', 23, '武汉', '2017-07-14', 1, 'html5的运用', '999', 0, 1, 1, 1, 0, 00000000001);
INSERT INTO `ehr_emp` VALUES (5, 'DengXiaoKang', NULL, '/other/img/2018/02/26/5faefad0-a3b2-4472-9afa-f328c04d5c87.jpg', '邓康', '123', '/other/img/4.png', '1995-03-16', '男', '12323123', '691873271', '', 23, '武汉', '2017-08-24', 1, 'html5的运用', '999', 0, 1, 3, 1, 1, 00000000000);
INSERT INTO `ehr_emp` VALUES (6, 'Xiaojihang', NULL, '/other/img/2018/02/26/5faefad0-a3b2-4472-9afa-f328c04d5c87.jpg', '肖霁航', '123', '/other/img/4.png', '1995-07-16', '男', '12323123', '1554844470', '', 23, '宜昌', '2014-01-24', 1, 'JavaScript', '999', 0, 2, 2, 1, 1, 00000000001);
INSERT INTO `ehr_emp` VALUES (7, 'LiXiaoChen', NULL, '/other/img/2018/02/26/5faefad0-a3b2-4472-9afa-f328c04d5c87.jpg', '刘欢', '123', '/other/img/4.png', '1995-03-16', '男', '12323123', '1369191990', '', 23, '宜昌', '2015-02-24', 1, 'JavaScript', '999', 0, 2, 1, 1, 0, 00000000000);
INSERT INTO `ehr_emp` VALUES (8, 'LiangYong', NULL, '/other/img/2018/02/26/5faefad0-a3b2-4472-9afa-f328c04d5c87.jpg', '莫小溪', '123', '/other/img/4.png', '1995-07-16', '女', '12323123', '811648935', '', 23, '北京', '2016-03-24', 1, 'JavaScript', '999', 0, 2, 1, 12, 0, 00000000001);
INSERT INTO `ehr_emp` VALUES (9, 'KeTeng', NULL, '/other/img/2.jpg', '柯腾', '123', '/other/img/4.png', '1995-03-16', '男', '12323123', '895123919', '', 23, '宜昌', '2017-04-24', 1, 'JavaScript', '999', 0, 2, 1, 5, 0, 00000000001);
INSERT INTO `ehr_emp` VALUES (10, 'ZhouXinYao', NULL, '/other/img/2018/02/26/5faefad0-a3b2-4472-9afa-f328c04d5c87.jpg', '周鑫尧', '123', '/other/img/4.png', '1995-03-16', '男', '12323123', '1712981535', '', 23, '杭州', '2015-06-25', 1, 'JavaScript', '999', 0, 3, 3, 6, 1, 00000000001);
INSERT INTO `ehr_emp` VALUES (11, 'LeeYe', NULL, NULL, '离夜', '234', NULL, NULL, '人妖', '10302020202', '2273711570', '1394003508@qq.com', 23, '杭州', NULL, NULL, NULL, NULL, NULL, 2, NULL, 6, NULL, NULL);
INSERT INTO `ehr_emp` VALUES (10021, '55', NULL, NULL, '5566', '123', NULL, NULL, '男', '123456', '123456', '123456', 12, '111', NULL, NULL, NULL, NULL, NULL, 1, NULL, 1, NULL, NULL);
...
CREATE TABLE `ehr_holiday`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 12 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '节假日表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ehr_paygrades`  (
  ...
  `logicToDelete` int(2) NULL DEFAULT 1 COMMENT '逻辑删除字段',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '薪资等级表' ROW_FORMAT = Dynamic;
...
-- ----------------------------
INSERT INTO `ehr_position` VALUES (1, '123', '  负责公司工作方向，制定工作制度', 3, NULL);
...
CREATE TABLE `ehr_recruitmentdemand`  (
  ...
  `logicToDelete` int(2) NULL DEFAULT 1 COMMENT '逻辑删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 52 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '招聘需求表' ROW_FORMAT = Dynamic;
...
INSERT INTO `ehr_recruitmentdemand` VALUES (19, '会做冬菇烧蹄筋', 4, 1870, '1999-09-22', 2, 'rt', 2, 1);
...
CREATE TABLE `ehr_releases`  (
  ...
  `hiring` int(11) NULL DEFAULT NULL COMMENT '招聘人数',
  `wageBudget` int(11) NULL DEFAULT NULL COMMENT '薪资预算',
  `initiateTime` datetime(0) NULL DEFAULT NULL COMMENT '发起时间',
  `state` int(2) NULL DEFAULT NULL COMMENT '状态',
  `mark` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '备注',
  `emp_id` int(11) NULL DEFAULT NULL COMMENT '发布人',
  ...
  `logicToDelete` int(2) NULL DEFAULT 1 COMMENT '逻辑删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 59 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '招聘信息发布表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of ehr_releases
-- ----------------------------
INSERT INTO `ehr_releases` VALUES (1, '会做广式卤鸭翅', 5, 1900, '1999-09-08 00:00:00', 2, 'dq', 3, 1, 0);
INSERT INTO `ehr_releases` VALUES (2, '会做蒸花鸭111', 1211, 180011, '1999-09-16 00:00:00', 2, 'qqq11', 2, 2, 1);
...
CREATE TABLE `ehr_rewardpunish`  (
  ...
  `logicToDelete` int(2) NULL DEFAULT 1 COMMENT '逻辑删除字段',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5595 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '奖罚表' ROW_FORMAT = Dynamic;
...
INSERT INTO `ehr_rewardpunish` VALUES (13, '全勤奖励', 300, 1, '2018-04-04', 10, 1);
...
INSERT INTO `ehr_rewardpunish` VALUES (5558, '旷工罚款', 100, 0, '2018-04-23', 15, 1);
INSERT INTO `ehr_rewardpunish` VALUES (5559, '旷工罚款', 100, 0, '2018-04-24', 15, 1);
INSERT INTO `ehr_rewardpunish` VALUES (5560, '迟到罚款', 30, 0, '2018-04-23', 20, 1);
INSERT INTO `ehr_rewardpunish` VALUES (5561, '旷工罚款', 100, 0, '2018-04-24', 20, 1);
INSERT INTO `ehr_rewardpunish` VALUES (5562, '旷工罚款', 100, 0, '2018-04-23', 21, 1);
INSERT INTO `ehr_rewardpunish` VALUES (5563, '迟到罚款', 30, 0, '2018-04-24', 21, 1);
INSERT INTO `ehr_rewardpunish` VALUES (5564, '旷工罚款', 100, 0, '2018-04-23', 22, 1);
INSERT INTO `ehr_rewardpunish` VALUES (5565, '旷工罚款', 100, 0, '2018-04-24', 22, 1);
INSERT INTO `ehr_rewardpunish` VALUES (5566, '旷工罚款', 100, 0, '2018-04-23', 23, 1);
INSERT INTO `ehr_rewardpunish` VALUES (5567, '旷工罚款', 100, 0, '2018-04-24', 23, 1);
INSERT INTO `ehr_rewardpunish` VALUES (5568, '旷工罚款', 100, 0, '2018-04-23', 24, 1);
INSERT INTO `ehr_rewardpunish` VALUES (5569, '旷工罚款', 100, 0, '2018-04-24', 24, 1);
INSERT INTO `ehr_rewardpunish` VALUES (5570, '旷工罚款', 100, 0, '2018-04-23', 25, 1);
INSERT INTO `ehr_rewardpunish` VALUES (5571, '旷工罚款', 100, 0, '2018-04-24', 25, 1);
INSERT INTO `ehr_rewardpunish` VALUES (5572, '旷工罚款', 100, 0, '2018-04-23', 26, 1);
INSERT INTO `ehr_rewardpunish` VALUES (5573, '旷工罚款', 100, 0, '2018-04-24', 26, 1);
INSERT INTO `ehr_rewardpunish` VALUES (5574, '旷工罚款', 100, 0, '2018-04-23', 27, 1);
INSERT INTO `ehr_rewardpunish` VALUES (5575, '旷工罚款', 100, 0, '2018-04-24', 27, 1);
INSERT INTO `ehr_rewardpunish` VALUES (5576, '旷工罚款', 100, 0, '2018-04-23', 28, 1);
INSERT INTO `ehr_rewardpunish` VALUES (5577, '旷工罚款', 100, 0, '2018-04-24', 28, 1);
INSERT INTO `ehr_rewardpunish` VALUES (5578, '旷工罚款', 100, 0, '2018-04-23', 30, 1);
INSERT INTO `ehr_rewardpunish` VALUES (5579, '旷工罚款', 100, 0, '2018-04-24', 30, 1);
INSERT INTO `ehr_rewardpunish` VALUES (5580, '旷工罚款', 100, 0, '2018-04-23', 31, 1);
INSERT INTO `ehr_rewardpunish` VALUES (5581, '旷工罚款', 100, 0, '2018-04-24', 31, 1);
INSERT INTO `ehr_rewardpunish` VALUES (5582, '旷工罚款', 100, 0, '2018-04-23', 32, 1);
INSERT INTO `ehr_rewardpunish` VALUES (5583, '旷工罚款', 100, 0, '2018-04-24', 32, 1);
INSERT INTO `ehr_rewardpunish` VALUES (5584, '旷工罚款', 100, 0, '2018-04-23', 10007, 0);
INSERT INTO `ehr_rewardpunish` VALUES (5585, '旷工罚款', 100, 0, '2018-04-24', 10007, 0);
INSERT INTO `ehr_rewardpunish` VALUES (5586, '旷工罚款', 100, 0, '2018-04-23', 10008, 0);
INSERT INTO `ehr_rewardpunish` VALUES (5587, '旷工罚款', 100, 0, '2018-04-24', 10008, 0);
INSERT INTO `ehr_rewardpunish` VALUES (5588, '旷工罚款', 100, 0, '2018-04-23', 10009, 0);
INSERT INTO `ehr_rewardpunish` VALUES (5589, '旷工罚款', 100, 0, '2018-04-24', 10009, 0);
INSERT INTO `ehr_rewardpunish` VALUES (5590, '旷工罚款', 100, 0, '2018-04-23', 10010, 0);
INSERT INTO `ehr_rewardpunish` VALUES (5591, '旷工罚款', 100, 0, '2018-04-24', 10010, 0);
INSERT INTO `ehr_rewardpunish` VALUES (5592, '旷工罚款', 100, 0, '2018-04-24', 10015, 0);
INSERT INTO `ehr_rewardpunish` VALUES (5593, '万事达', 213, 1, '2019-01-24', 1, 0);
INSERT INTO `ehr_rewardpunish` VALUES (5594, '333', 111, 1, '2019-06-29', 2, NULL);
...
CREATE TABLE `ehr_rule`  (
  ...
  `logictoDelete` int(2) NULL DEFAULT 1 COMMENT '逻辑删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '考勤规则表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of ehr_rule
-- ----------------------------
INSERT INTO `ehr_rule` VALUES (1, '夏天打卡规则', 4, '08:30', '12:30', '14:40', '18:11', '湖北省武汉市洪山区花山镇大长山路联投青年城', 30, 1, 0);
...
CREATE TABLE `ehr_socialsecurity`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 23 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '社保表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ehr_talentpool`  (
  ...
  `logicToDelete` int(2) NULL DEFAULT 1 COMMENT '逻辑删除字段',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 23 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '人才库储备表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of ehr_talentpool
-- ----------------------------
INSERT INTO `ehr_talentpool` VALUES (1, '张无忌', 1, '13578966542', '624366789', '1834082722@qq.com', 25, '湖北省武汉市', 'DBA', '沉稳扎实', '诺基亚', '12', 1);
INSERT INTO `ehr_talentpool` VALUES (2, '叶秋', 1, '13674593616', '694623668', '694623668@aliyun.com', 28, '江苏省南京市', 'OP', '开朗', '佳能', '66', 1);
...
-- ----------------------------
-- Table structure for ym_qywx
-- ----------------------------
DROP TABLE IF EXISTS `ym_qywx`;
CREATE TABLE `ym_qywx`  (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '编号',
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '应用名称',
  `agentid` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '应用id',
  `secret` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '应用秘钥',
  `expires_time` bigint(20) NULL DEFAULT NULL COMMENT '到期时间',
  `access_token` varchar(1000) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '访问票据',
  `create_time` timestamp(0) NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '创建时间',
  `update_time` timestamp(0) NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '更新时间',
  `del_flag` int(2) NULL DEFAULT NULL COMMENT '删除标志(0：删除、1：未删除)',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '企业微信应用表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of ym_qywx
-- ----------------------------
INSERT INTO `ym_qywx` VALUES (1, '微信打卡', '3010011', 'dPgZpktgG1KXweNmfnArUnCCqKbefcL6zvkj9iFYnWA', 1548481933628, 'Cj4_Rqg4O_EGTqWj_JjYJcQ6ZdP485FtfeRwXKwbxs1ZyXO_h0H-SZU2If-61pue6e5vLTJvTVpzv6hfX5ETFvFD2B_h_w01B-zx0HDdnZb1AOy6MBhQ0LrUDMZaPzdYxYVjRPo3Z_nPu2v2ohEayhxuMYxPY66sxKVtKhWcxT3eHuMvHXLjDD5ZK7uwNCnP4zrWPmDXHxWhORYLup5veQ', '2019-01-20 10:28:45', '2019-01-26 12:52:14', 1);
INSERT INTO `ym_qywx` VALUES (2, '通讯录同步', '2', '3L0f_HtHnAicz69ffNGxxLDQ1_jJqCTH-HgNKR8uLfc', 1548481933783, 'Cj4_Rqg4O_EGTqWj_JjYJcQ6ZdP485FtfeRwXKwbxs2XStfWwjXHFQWz7flLpj_fWsHmDCOv3-k9mNu8uVE7XbirnHH0a4qjgypN-DWZgPrVNm17y2FmaQPgJa8brp1LuS5dbWpsQ7bC3ISictJwqDtKmLgOUbDUEVSHKagImPvoBUvR9SRBZBWiRT0ftAJ7YXX2LId-s8SCcVUK_Q8OTw', '2019-01-22 17:12:00', '2019-01-26 12:52:14', 1);
...
CREATE TABLE `ym_user`  (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '编号',
  `login_name` varchar(1000) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '登录名',
  `login_pwd` varchar(1000) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '登录密码',
  `user_name` varchar(1000) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '用户昵称',
  `sex` int(11) NULL DEFAULT NULL COMMENT '性别',
  `birthday` date NULL DEFAULT NULL COMMENT '生日',
  `age` int(11) NULL DEFAULT NULL COMMENT '年龄',
  `head_img` varchar(2000) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '头像',
  `create_time` timestamp(0) NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '创建时间',
  `update_time` timestamp(0) NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '更新时间',
  `del_flag` int(2) NULL DEFAULT NULL COMMENT '删除标志(0：删除、1：未删除)',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 45 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of ym_user
-- ----------------------------
INSERT INTO `ym_user` VALUES (1, '1', '1', '2', 1, '2018-02-05', NULL, '', '2019-01-17 10:05:29', '2019-01-17 10:05:29', 1);
INSERT INTO `ym_user` VALUES (2, NULL, NULL, '2', NULL, NULL, NULL, NULL, '2019-01-15 16:43:04', '2019-01-15 16:43:04', 0);
INSERT INTO `ym_user` VALUES (3, NULL, NULL, '1', NULL, NULL, NULL, NULL, '2019-01-15 16:43:04', '2019-01-15 16:43:04', 0);
INSERT INTO `ym_user` VALUES (4, '2', '2', '1', 1, '2019-01-23', NULL, 'other/img/2019/01/11/62f44e8d-416d-4c1d-85bf-cc34adfcd508.jpg', '2019-01-15 16:44:40', '2019-01-15 16:44:40', 0);
INSERT INTO `ym_user` VALUES (5, NULL, NULL, '1', NULL, NULL, NULL, NULL, '2019-01-11 18:04:50', '2019-01-11 18:04:50', 1);
INSERT INTO `ym_user` VALUES (6, NULL, NULL, '1', NULL, NULL, NULL, NULL, '2019-01-20 09:39:39', '2019-01-20 09:39:39', 0);
INSERT INTO `ym_user` VALUES (7, '惹我', '11', '1', 1, '2018-02-13', NULL, NULL, '2019-01-14 19:54:40', '2019-01-14 19:54:40', 0);
INSERT INTO `ym_user` VALUES (8, '惹我', '11', '1', 1, '2018-02-13', NULL, NULL, '2019-01-14 19:54:45', '2019-01-14 19:54:45', 0);
...
INSERT INTO `ym_user` VALUES (12, '诶我去', '1', '1', 1, '2018-02-28', NULL, NULL, '2019-01-14 19:54:48', '2019-01-14 19:54:48', 0);
INSERT INTO `ym_user` VALUES (13, '1326060', '121', '1', 0, '2018-03-20', NULL, '', '2019-01-16 19:20:53', '2019-01-16 19:20:53', 1);
...
INSERT INTO `ym_user` VALUES (33, 'das', 'dsa', '1', 1, '2018-03-22', NULL, 'other/img/2018/03/29/ac5b5b6a-145b-4b3d-abae-46e02f7984ad.png', '2019-01-14 19:54:55', '2019-01-14 19:54:55', 0);
INSERT INTO `ym_user` VALUES (34, 'ww', '11', '1', 1, '2018-12-19', NULL, '', '2019-01-14 19:56:26', '2019-01-14 19:56:26', 0);
INSERT INTO `ym_user` VALUES (35, '231', '32131', '1', 1, '2018-12-27', NULL, 'other/img/2018/12/17/b937ad67-04e1-4b68-bdf3-b223f56b8b78.png', '2019-01-14 19:56:26', '2019-01-14 19:56:26', 0);
INSERT INTO `ym_user` VALUES (37, '1312', '312', '1', 1, '2019-01-30', NULL, '', '2019-01-16 11:54:36', '2019-01-16 11:54:36', 0);
...
INSERT INTO `ym_user` VALUES (40, '1', '31', '2', 0, '2019-01-25', NULL, 'other/img/2019/01/11/f29b5f7e-4df5-40b7-88c8-0555738c8d3d.jpg', '2019-01-16 11:54:36', '2019-01-16 11:54:36', 0);
INSERT INTO `ym_user` VALUES (41, '2', '231', '12321', 0, '2019-01-23', NULL, 'other/img/2019/01/14/7ba1546a-f3ef-427d-a5c5-5c85b2d8a82a.gif', '2019-01-15 13:17:24', '2019-01-15 13:17:24', 0);
INSERT INTO `ym_user` VALUES (42, 'yui', 'yui', 'yui', 1, '2019-01-17', NULL, '', NULL, NULL, 1);
INSERT INTO `ym_user` VALUES (43, '1', '1', '111', 1, '2019-01-24', NULL, '', '2019-01-16 19:22:02', '2019-01-16 19:22:02', 0);
INSERT INTO `ym_user` VALUES (44, '华为', '123456', 'huawei', 1, '2019-01-31', NULL, '', NULL, NULL, 1);

-- ----------------------------
-- View structure for v_att_emp
-- ----------------------------
DROP VIEW IF EXISTS `v_att_emp`;
CREATE ALGORITHM = UNDEFINED SQL SECURITY DEFINER VIEW `v_att_emp` AS select `ea`.`id` AS `id`,`ea`.`clockInTime` AS `clockInTime`,`ea`.`clockInIocation` AS `clockInIocation`,`ea`.`tag` AS `tag`,`ea`.`emp_id` AS `emp_id`,`ea`.`logictoDelete` AS `logictoDelete`,`ee`.`name` AS `name` from (`ehr_attendance` `ea` join `ehr_emp` `ee` on((`ea`.`emp_id` = `ee`.`id`)));
